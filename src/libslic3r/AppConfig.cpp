...
static const std::string VERSION_CHECK_URL = "http://raw.githubusercontent.com/Fusion3Design/F3slic3r/master/updates/F3Slic3r.version";
//static const std::string VERSION_CHECK_URL = "http://files.prusa3d.com/wp-content/uploads/repository/PrusaSlicer-settings-master/live/PrusaSlicer.version2";
// Url to index archive zip that contains latest indicies
static const std::string INDEX_ARCHIVE_URL= "http://raw.githubusercontent.com/Fusion3Design/F3slic3r/master/updates/vendor_indices.zip";
// Url to folder with vendor profile files. Used when downloading new profiles that are not in resources folder.
static const std::string PROFILE_FOLDER_URL = "http://raw.githubusercontent.com/Fusion3Design/F3slic3r/master/updates/";
