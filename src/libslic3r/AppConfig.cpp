...
static const std::string VERSION_CHECK_URL = "http://127.0.0.1/downloads/PrusaSlicer.version";
...
static const std::string INDEX_ARCHIVE_URL= "http://127.0.0.1/wp-content/uploads/repository/vendor_indices.zip";
// Url to folder with vendor profile files. Used when downloading new profiles that are not in resources folder.
static const std::string PROFILE_FOLDER_URL = "http://127.0.0.1/wp-content/uploads/repository/PrusaSlicer-settings-master/live/";
