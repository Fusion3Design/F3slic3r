...
#if SLIC3R_OPENGL_ES
                _L("F3Slic3r requires OpenGL ES 3.0 capable graphics driver to run correctly, \n"
...
#endif
        	wxMessageBox(message, wxString("F3Slic3r - ") + _L("Unsupported OpenGL version"), wxOK | wxICON_ERROR);
        }
