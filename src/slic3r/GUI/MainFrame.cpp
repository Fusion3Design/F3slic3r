...
public:
    ...
    wxMenu *CreatePopupMenu() override {
        ...
        if(wxGetApp().app_config->get("single_instance") == "0") {
            ...
            append_menu_item(menu, wxID_ANY, _L("Open new instance"), _L("Open a new F3Slic3r instance"),
...
public:
    ...
    wxMenu *CreatePopupMenu() override {
        wxMenu *menu = new wxMenu;
        append_menu_item(menu, wxID_ANY, _L("Open F3Slic3r"), _L("Open a new F3Slic3r instance"),
...
//       _L("Remember to check for updates at https://github.com/prusa3d/PrusaSlicer/releases"));
    ...
    Bind(wxEVT_CLOSE_WINDOW, [this](wxCloseEvent& event) {
        ...
        if (m_plater != nullptr) {
            int saved_project = m_plater->save_project_if_dirty(_L("Closing F3Slic3r. Current project is modified."));
            ...
            // check unsaved changes only if project wasn't saved
                     ...
                     (plater()->is_presets_dirty() && !wxGetApp().check_and_save_current_preset_changes(_L("F3Slic3r is closing"), _L("Closing F3Slic3r while some presets are modified.")))) {
                event.Veto();
                return;
            }
        }
...
static wxMenu* generate_help_menu()
{
    ...
    append_menu_item(helpMenu, wxID_ANY, _L("Software &Releases"), _L("Open the software releases page in your browser"),
        [](wxCommandEvent&) { wxGetApp().open_browser_with_warning_dialog("https://github.com/Fusion3Design/F3slic3r", nullptr, false); });
...
//            [this](wxCommandEvent&) { wxGetApp().open_browser_with_warning_dialog("http://manual.slic3r.org/"); });
    ...
    append_menu_item(helpMenu, wxID_ANY, _L("Report an I&ssue"), wxString::Format(_L("Report an issue on %s"), SLIC3R_APP_NAME),
        [](wxCommandEvent&) { wxGetApp().open_browser_with_warning_dialog("https://github.com /Fusion3Design/F3slic3r/issues/new", nullptr, false); });
#ifndef __APPLE__
...
void MainFrame::init_menubar_as_gcodeviewer()
{
    wxMenu* fileMenu = new wxMenu;
    {
        ...
        append_menu_item(fileMenu, wxID_ANY, _L("Export &Toolpaths as OBJ") + dots, _L("Export toolpaths as OBJ"),
            ...
            [this]() {return can_export_toolpaths(); }, this);
        append_menu_item(fileMenu, wxID_ANY, _L("Open &F3Slic3r") + dots, _L("Open F3Slic3r"),
            [](wxCommandEvent&) { start_new_slicer(); }, "", nullptr,
            []() { return true; }, this);
        fileMenu->AppendSeparator();
        append_menu_item(fileMenu, wxID_EXIT, _L("&Quit"), wxString::Format(_L("Quit %s"), SLIC3R_APP_NAME),
